...
function Menu() {
    ...
    return (
        <main className="menu">
            ...
            {pizzass ?
                <>
                <p>Authentic italian cuisine . 6 creative dishes to choose from our stone oven , all organic , all Yummi </p>
            <ul className="pizzas">
                {pizzaData.map((pizza) => (
...
function Order({closeHour}) {
    return (
        <div className="order">
            <p>we're open untill {closeHour} come visit us or order online </p>
